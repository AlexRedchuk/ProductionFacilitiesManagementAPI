        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Code = table.Column<string>(type: "varchar(255)", nullable: false),
                    Description = table.Column<string>(type: "longtext", nullable: false),
                    EquipmentArea = table.Column<double>(type: "double", nullable: false),
                    AreaUsed = table.Column<double>(type: "double", nullable: false, defaultValue: 0.0)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductionFacilityCode = table.Column<string>(type: "varchar(255)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "ContractEquipmentTypes",
                columns: table => new
                {
                    ContractNumber = table.Column<string>(type: "varchar(255)", nullable: false),
                    equipmentTypeCode = table.Column<string>(type: "varchar(255)", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContractEquipmentTypes", x => new { x.ContractNumber, x.equipmentTypeCode });
                    table.ForeignKey(
                        name: "FK_ContractEquipmentTypes_Contracts_ContractNumber",
                        column: x => x.ContractNumber,
                        principalTable: "Contracts",
                        principalColumn: "Number",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContractEquipmentTypes_EquipmentTypes_equipmentTypeCode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContractEquipmentTypes_equipmentTypeCode",
                table: "ContractEquipmentTypes",
